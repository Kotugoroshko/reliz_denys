...
let height = Math.max(parseInt(window.getComputedStyle(team1).getPropertyValue('height')), parseInt(window.getComputedStyle(team2).getPropertyValue('height')), parseInt(getComputedStyle(team3).getPropertyValue('height')))
...
let item_names = ['REDMI NOTE 13 PRO 5G 128/6GB',
 'Redmi Note 13 Pro+ 5G 256/8GB',
  'REDMI NOTE 12 PRO 5G 128/6GB',
   'REDMI NOTE 12 PRO 5G 256/8GB',
    'REDMI NOTE 11 128/4GB',
    'REDMI NOTE 11 PRO 5G 128/8GB',
    'REDMI NOTE 11 PRO+ 5G 128/8GB',
    'REDMI NOTE 10 PRO']
...
let item_descriptions = ['Смартфон вийшов 202 року',
 'Смартфон вийшов 2023 року',
  'Смартфон вийшов 2023 року',
   'Смартфон вийшов 2023 року',
   'Смартфон вийшов 2021 року',
   'Смартфон вийшов 2022 року',
   'Смартфон вийшов 2022 року',
   'Смартфон вийшов 2021 року']
let item_prices = [11000, 23000, 15000, 16000, 8000, 11000, 12199, 10000]
...
function change_theme() {
   ...
   if (current_background == 'url(https://opis-cdn.tinkoffjournal.ru/mercury/xiaomi-14-preview-04.dog7qbfgfzgv..jpg)') {
       current_background = 'url(https://s.ek.ua/posts/files/2284/wide_pic.jpg)'
   } else {
       current_background = 'url(https://opis-cdn.tinkoffjournal.ru/mercury/xiaomi-14-preview-04.dog7qbfgfzgv..jpg)'
   }
...
let current_background = '(https://opis-cdn.tinkoffjournal.ru/mercury/xiaomi-14-preview-04.dog7qbfgfzgv..jpg)'
...
function make_colorful() {
    send_btn.style.backgroundColor = '#89a08e'
}
...
function display_message(){
    alert("Вітаємо вас на нашому інтернет-магазині смартфонів Xiaomi! Натисніть на кнопку ОК для продовження")
}
